...
public:
    ...
    IteratorBidirectional() { set_pointers_to_zero(); }

    IteratorBidirectional(IteratorBidirectional &input) { assign(input); }
    ...
    IteratorBidirectional &operator--() const { return *prev_; }
